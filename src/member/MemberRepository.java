...
public class MemberRepository {
    List<Member> members = new ArrayList<>(Arrays.asList(
            ...
            new Student(20221001, 20221001, "김지형", "컴퓨터공학", 4, 21),
            new Student(20221002, 20221002, "윤상혁", "글로벌IT학", 3, 21),
            new Student(20221003, 20221003, "이기호", "소프트웨어공학", 2, 21),
            new Student(20221004, 20221004, "최영근", "소프트웨어공학", 3, 21),
            new Student(20221005, 20221005, "홍수경", "컴퓨터공학", 1, 21)
    ));
